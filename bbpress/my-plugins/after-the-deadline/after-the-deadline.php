...
//defines
define('ATD_VER', '1.2'); //version number of the plugin
...
function atd_css_js(){ //enqueues & prints script and style
	if(bb_is_user_logged_in()){ //only when the user is logged in
		...
		if(function_exists('wp_enqueue_style') && function_exists('wp_enqueue_script')){ //bb 1.0+
			...
			wp_enqueue_script('after-the-deadline-js', ATD_PLUGPATH."scripts/atd.js", array('jquery'), ATD_VER, true);
