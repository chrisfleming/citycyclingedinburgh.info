...
<!-- content END -->
	...
	<div id="footer">
		...
		<a id="powered" href="http://bbpress.org/">bbPress</a> - <a href="http://www.bbpressthemes.net">bbPress Themes</a>
		<div id="copyright"> Copyright © 2009 <?php bb_option('name'); ?> </div>
			<div id="themeinfo">
				<?php _e('Theme by <a href="http://www.neoease.com/">mg12</a> &amp; <a href="http://ericlbarnes.com/">Eric Barnes</a>. Valid <a href="http://validator.w3.org/check?uri=referer">XHTML 1.1</a> and <a href="http://jigsaw.w3.org/css-validator/">CSS 3</a>.', 'inove'); ?>
			</div>
	</div>
