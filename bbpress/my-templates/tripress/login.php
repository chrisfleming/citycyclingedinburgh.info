...
?>
	...
	<tr>
		...
		<td>
			...
			<input class="accbutton" type="submit" value="<?php echo esc_attr( isset($_POST['user_login']) ? __('Try Again &raquo;'): __('Log in &raquo;') ); ?>" />
...
<fieldset>
	...
	<table>
		...
		<tr valign="top">
			<th scope="row"></th>
			<td>
				<input class="accbutton" type="submit" value="<?php echo esc_attr__( 'Recover Password &raquo;' ); ?>" />
			</td>
		</tr>
	</table>
</fieldset>
